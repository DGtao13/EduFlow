    ...
    Scaffold(topBar = { EduFlowRootTopAppBar(stringResource(R.string.nav_more)) }) { padding ->
        Column(Modifier.fillMaxSize().padding(padding).padding(horizontal = 16.dp)) {
            ...
            SettingsSection(stringResource(R.string.settings)) {
                SettingsRow(stringResource(R.string.notifications), stringResource(R.string.notifications_supporting), Icons.Default.Notifications, onClick = { navController.navigate("notification_settings") })
            }
            ...
            SettingsSection(stringResource(R.string.about_section)) {
                SettingsRow(stringResource(R.string.about_eduflow), stringResource(R.string.about_supporting), Icons.Default.Info, onClick = { navController.navigate("about") })
            }
        }
    }
}
